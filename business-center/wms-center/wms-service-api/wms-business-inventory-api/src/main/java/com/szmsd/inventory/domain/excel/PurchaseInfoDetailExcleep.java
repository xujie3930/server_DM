...
@ApiModel(description = "PurchaseInfoDetailExcleep")
public class PurchaseInfoDetailExcleep {
    ...
    private List<PurchaseStorageDetailsExclesp> purchaseStorageDetailsExclesp;
}
