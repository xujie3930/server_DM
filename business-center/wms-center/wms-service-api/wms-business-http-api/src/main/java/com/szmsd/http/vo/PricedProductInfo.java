...
@ApiModel(value = "PricedProduct", description = "物流产品")
public class PricedProductInfo {
    ...
    @ApiModelProperty(value = "核重后挂号获取方式")
    ...
    @ApiModelProperty(value = "服务的地址长度限制(Address1+Address2+Address3)")
    ...
    @ApiModelProperty(value = "包裹申报名称中文名是否必须的")
    ...
    @ApiModelProperty(value = "LastModifyOperation")
