...
public class DelOutboundExportListVO implements Serializable {
    ...
    @Excel(name = "邮编",width = 30)
    private String postCode;

    @ExcelProperty(value = {"国家", "Country"})
    @Excel(name = "国家",width = 30)
