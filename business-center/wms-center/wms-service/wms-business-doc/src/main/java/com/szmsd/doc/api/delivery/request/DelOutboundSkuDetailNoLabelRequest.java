 ...
 */
@Data
@ApiModel(value = "DelOutboundSkuDetailNoLabelRequest", description = "DelOutboundSkuDetailNoLabelRequest对象")
public class DelOutboundSkuDetailNoLabelRequest implements Serializable {
