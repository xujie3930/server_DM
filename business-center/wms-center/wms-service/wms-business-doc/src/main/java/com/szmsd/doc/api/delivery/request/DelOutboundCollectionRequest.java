...
public class DelOutboundCollectionRequest implements Serializable {
    ...
    /*@NotBlank(message = "客户编码不能为空", groups = {DelOutboundGroup.Collection.class})
    ...
    @NotBlank(message = "仓库编码不能为空", groups = {DelOutboundGroup.Collection.class})
    ...
    @Size(max = 50, message = "增值税号不能超过50个字符", groups = {DelOutboundGroup.Collection.class})
    ...
    @NotBlank(message = "物流服务不能为空", groups = {DelOutboundGroup.Collection.class})
    @Size(max = 50, message = "物流服务不能超过50个字符", groups = {DelOutboundGroup.Collection.class})
    ...
    @Size(max = 50, message = "参考号不能超过50个字符", groups = {DelOutboundGroup.Collection.class})
    @ApiModelProperty(value = "参考号", dataType = "String", position = 5, example = "")
    private String refNo;

    @Size(max = 500, message = "备注不能超过500个字符", groups = {DelOutboundGroup.Collection.class})
    ...
    @ApiModelProperty(value = "明细信息", dataType = "DelOutboundSkuDetailRequest", position = 8)
