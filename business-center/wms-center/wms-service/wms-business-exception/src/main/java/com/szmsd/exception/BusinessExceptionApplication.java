...
@EnableScheduling
public class BusinessExceptionApplication {

    public static void main(String[] args) {
        SpringApplication.run(BusinessExceptionApplication.class, args);
        System.out.println("(♥◠‿◠)ﾉﾞ  异常信息模块启动成功   ლ(´ڡ`ლ)ﾞ  \n" +
                " .-------.       ____     __        \n" +
                " |  _ _   \\      \\   \\   /  /    \n" +
                " | ( ' )  |       \\  _. /  '       \n" +
                " |(_ o _) /        _( )_ .'         \n" +
