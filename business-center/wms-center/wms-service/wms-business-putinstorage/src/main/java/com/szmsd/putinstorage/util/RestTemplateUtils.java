...
public class RestTemplateUtils {
    ...
    public static <T> ResponseEntity<T> post(String url, Object requestBody, Class<T> responseType) {
        return new RestTemplate().postForEntity(url, requestBody, responseType);
    }
     ...
     * @return
     */
    public static <T> ResponseEntity<T> formPost(String url, MultiValueMap<String, Object> params, Class<T> responseType) {
