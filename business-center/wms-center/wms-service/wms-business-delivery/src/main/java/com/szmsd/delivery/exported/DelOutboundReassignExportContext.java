 ...
 */
public class DelOutboundReassignExportContext implements ReassignExportContext {
    ...
    public DelOutboundReassignExportContext(BasWarehouseClientService basWarehouseClientService, BasRegionFeignService basRegionFeignService, String... len) {
    ...
    public void setTrackingStatusCacheAdapter(List<BasSubWrapperVO> list) {
