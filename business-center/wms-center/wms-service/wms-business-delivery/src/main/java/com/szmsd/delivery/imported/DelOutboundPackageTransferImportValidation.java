 ...
 */
public class DelOutboundPackageTransferImportValidation implements ImportValidation<DelOutboundPackageTransferImportDto> {

    private final DelOutboundOuterContext outerContext;
    private final DelOutboundPackageTransferImportContext importContext;

    public DelOutboundPackageTransferImportValidation(DelOutboundOuterContext outerContext, DelOutboundPackageTransferImportContext importContext) {
        this.outerContext = outerContext;
        this.importContext = importContext;
    }

    @Override
    public void valid(int rowIndex, DelOutboundPackageTransferImportDto object) {
