 ...
 */
@Service
public class SysDeptServiceCopyImpl implements ISysDeptServiceCopy
{
    @Resource
    private SysDeptMapperCopy deptMapper;
     ...
     */
    @Override
    public int insertDept(SysDept dept) throws BaseException {
    ...
    {
        String updateByName = dept.getUpdateByName();
        dept = deptMapper.selectDeptById(dept.getId());
        dept.setUpdateByName(updateByName);
