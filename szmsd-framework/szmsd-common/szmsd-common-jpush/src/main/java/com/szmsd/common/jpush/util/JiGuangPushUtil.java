package com.szmsd.common.jpush.util;
...
public class JiGuangPushUtil {
     ...
     * @param alert 推送的内容
     */
    public PushResult pushNotice(String masterSecret,String appkey,String type, String value, String alert) {
     ...
     * @param alert 推送的内容
     */
    public PushResult pushMsg(String masterSecret,String appkey, String type, String value, String alert) {
         JPushClient jPushClient = new JPushClient(masterSecret, appkey);
        ...
        if (type.equals("alias")) {
            ...
            builder.setAudience(Audience.all());//alias，说明采用广播方式推送，所有用户都可以接收到
        }
